...
function foLoader()
{
  ...
  document.getElementById("staticTickerLogoAcceptLabel").hidden = true;
  ...
  startDateAndTime.setMinutes(startDateAndTime.getMinutes() - startDateAndTime.getTimezoneOffset());
